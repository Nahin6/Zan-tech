          ...
          <div class="products-carousel swiper">
            <div class="swiper-wrapper">
              ...
              <div class="product-item swiper-slide">
                <a href="{{ route('addProductToWishListNew',$bestProducts->id) }}" class="btn-wishlist"><svg width="24" height="24"><use xlink:href="#heart"></use></svg></a>
                <figure>
                  <a href="{{ route('viewProductDetails',$bestProducts->id) }}" title="Product Title">
                    <img src="{{ asset('public/product_images/' . $bestProducts->productImg) }}" alt="Product Thumbnail" class="tab-image product-image">
                  </a>
                </figure>
